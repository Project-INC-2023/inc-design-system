    ...
    return (
      <AvatarGroupProvider limit={limit}>
        <div
          ref={ref}
          className={cn(
            "flex w-fit items-center -space-x-4 relative",
            className
          )}
          {...props}
        >
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <span
      ref={ref}
      className={cn(
        "relative flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-muted bg-white text-muted text-xs font-semibold shadow-sm border border-white border-opacity-50 z-10",
        className
      )}
      {...props}
    >
